...
exports.init = async context => {
    ...
    configPath = configPath === true ? 'usage.md' : configPath;
    ...
    if (getValue(appConfig, 'usage.md', false)) {
        config = require(path.join(appPath, appConfig.usage));
    }
};
